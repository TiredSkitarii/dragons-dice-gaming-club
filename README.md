...
This Project with made using HTML and Javascript
- The IDE used was Visual Studio Code (VSCode)
- Bootstrap CDN v5.3.8 was used in the construction of this Webpage
- FontAwesome was used to generate the Social Media Icons used on this webpage
- The Favicon logo was generated by Favicon.io
- Autoprefixer CSS Online used to validate the CSS code for all browsers
...
- Proof-reading performed by Jakob McLaughlin and 
...
###Code
- The Nav Bar and Event Cards were created using the generic Code from Bootstrap as a basis, and was customised with reference to previous code written for Code Institure Example projects Love Running and Boardwalk games.
